  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (terminal && terminal.length > 0) {
        ...
        return resolve({ status: true, successCode: 'PARAMETER_FILE_DOWNLOADED', blackList_Version: lastCreatedBlackList && lastCreatedBlackList.version ? lastCreatedBlackList.version : '', file: Files && Files.length > 0 ? Files[0].base64 : '' });
